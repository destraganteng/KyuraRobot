...
buttons = [
    ...
    [
        InlineKeyboardButton(text="ᴀʙᴏᴜᴛ", callback_data="Kyuraonly_"),
        InlineKeyboardButton(text="ᴛʀʏ ɪɴʟɪɴᴇ​", switch_inline_query_current_chat=""),
    ],
    [
        InlineKeyboardButton(
            text="sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ​", url="https://github.com/Kyuraxp/KyuraRobot"
        ),
...
EMI_IMG = "https://telegra.ph/file/d841005eca08d0ed2ef36.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project by contacting @kyuraonly \
...
def Skyzu_about_callback(update, context):
    query = update.callback_query
    if query.data == "Kyura_":
        query.message.edit_text(
            text="๏ I'm *Kyura*, a powerful group management bot built to help you manage your group easily."
            ...
            "\n\n_Kyura's licensed under the GNU General Public License v3.0_"
            "\n\n Click on button bellow to get basic help for KyuraRobot.",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="ᴀᴅᴍɪɴs​", callback_data="Kyura_admin"
                        ),
                        InlineKeyboardButton(
                            text="ɴᴏᴛᴇs​", callback_data="Kyura_notes"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                            text="sᴜᴘᴘᴏʀᴛ​", callback_data="Kyura_support"
                        ),
                        InlineKeyboardButton(
                            text="ᴄʀᴇᴅɪᴛs​", callback_data="Kyura_credit"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                    ...
                    [
                        InlineKeyboardButton(
                            text="ɢᴏ ʙᴀᴄᴋ​", callback_data="Kyura_back"
                        ),
                    ],
                ]
            ),
        )
    elif query.data == "Kyura_back":
        first_name = update.effective_user.first_name
        uptime = get_readable_time((time.time() - StartTime))
        query.message.edit_text(
            PM_START_TEXT.format(
        ...
        query.message.edit_text(
            ...
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="ɢᴏ ʙᴀᴄᴋ​", callback_data="Kyura_")]]
            ),
        )

    elif query.data == "Kyura_notes":
        query.message.edit_text(
    ...
    elif query.data == "Kyura_support":
        query.message.edit_text(
            text=f"*๏ {dispatcher.bot.first_name} support chats*"
            "\nJoin My Support Group/Channel for see or report a problem on Kyura.",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                    [
    ...
    elif query.data == "Kyura_credit":
        query.message.edit_text(
            text=f"<b>๏ Credis for Kyura</b>\n"
            f"\nHere Developers Making The KyuraRobot",
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text="ITSUKI", url="t.me/Kyuraonly"),
                    ],
                    [
                        InlineKeyboardButton(text="ɢᴏ ʙᴀᴄᴋ​", callback_data="Kyura_"),
                    ],
